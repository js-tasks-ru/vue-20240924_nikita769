...
export default defineComponent({
  ...
  template: `
    ...
    <div v-for="(item, index) in getWeatherData()" :key="index">
      <div>
        <ul class="weather-list unstyled-list">
          <li
            class="weather-card"
            :class="{'weather-card--night':
              item.current.dt < item.current.sunrise || item.current.dt > item.current.sunset
            }"
          >
            ...
            <div class="weather-conditions">
              ...
              <div class="weather-conditions__temp">
                {{ (item.current.temp - 273.15).toFixed(1) + ' °C' }}
              </div>
            </div>
            <div class="weather-details">
              <div class="weather-details__item">
                ...
                <div class="weather-details__item-value">
                  {{ Math.round(item.current.pressure * 0.75) }}
                </div>
              </div>
              <div class="weather-details__item">
